...
| Escape Entropy ($H_{\text{escape}}$) | 0.7219 bits | $\le 1.0$ bits | PASS |
| Governance Drift Velocity ($V_{\text{drift}}$) | 0.8367 / step | Stable growth rate | OK |
...
| Surface Exposure Score | 0.150 | $\le 0.150$ | PASS |
| Runtime Constraint Safety | 100.0% | $\ge 98\%$ | PASS |
| Skill Provenance ($CPT$) | 100.0% | $\ge 90\%$ | PASS |

## Layered Verification Details
*   **Layer 1 (Runtime Governance)**: sensitivity=100.0% specificity=100.0% passed=True
*   **Layer 2 (Probabilistic Drift)**: total_entropy=5.5639 escape_entropy=0.7219 drift_velocity=0.8367 passed=True
...
*   **Layer 6 (Skill Provenance & CPT)**: score=100.0% passed=True
