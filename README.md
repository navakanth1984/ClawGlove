...
<p align="center">
  <img src="assets/clawglove_architecture.png" alt="ClawGlove Sidecar Governance Plane Architecture" width="800"/>
</p>

* **Agent containers**: Reside in the `clawglove-internal` network (`internal: true`).
* **Fail-Closed Security**: There is **NO direct external route** to the internet. The only path is through the ClawGlove Sidecar. If the sidecar goes down, agents go dark instantly by design.
